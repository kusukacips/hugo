...
image_files_to_try = [
    "folder/boxing_cat.jpeg",
    "folder/boxing_cat.jpg", 
    "folder/boxing_cat.png",
    os.path.join("folder", "boxing_cat.jpeg"),
]
...
if st.session_state.cat_clicked:
    ...
    gift_images = ["folder/ayam.jpeg", "folder/kopi.jpeg", "folder/kucing.jpeg", "folder/love.jpeg", "folder/cipa.jpeg", "folder/susu.png"]
